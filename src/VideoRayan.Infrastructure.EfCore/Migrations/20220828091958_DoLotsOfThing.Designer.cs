...
namespace VideoRayan.Infrastructure.EfCore.Migrations
{
    ...
    [Migration("20220828091958_DoLotsOfThing")]
    partial class DoLotsOfThing
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("VideoRayan.Domain.AudienceFaceToFace", b =>
                {
                    b.Property<Guid>("FaceToFaceId")
                        .HasColumnType("uniqueidentifier");

                    b.Property<Guid>("AudienceId")
                        .HasColumnType("uniqueidentifier");

                    b.HasKey("FaceToFaceId", "AudienceId");

                    b.HasIndex("AudienceId");

                    b.ToTable("AudienceFaceToFaces");
                });
            ...
            modelBuilder.Entity("VideoRayan.Domain.MeetingAgg.FaceToFace", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("VideoRayan.Domain.MeetingAgg.Meeting", b =>
                {
                    ...
                    b.Property<string>("MasterPinCode")
                        .IsRequired()
                        .HasMaxLength(7)
            ...
            modelBuilder.Entity("VideoRayan.Domain.PlanAgg.Plan", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("VideoRayan.Domain.AudienceFaceToFace", b =>
                {
                    b.HasOne("VideoRayan.Domain.CustomerAgg.Audience", "Audience")
                        .WithMany("FaceToFaces")
                        .HasForeignKey("AudienceId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("VideoRayan.Domain.MeetingAgg.FaceToFace", "FaceToFace")
                        .WithMany("Audiences")
                        .HasForeignKey("FaceToFaceId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.Navigation("Audience");

                    b.Navigation("FaceToFace");
                });
